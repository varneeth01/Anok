...
export function ForEveryGamer() {
  return (
    <section className="py-20 sm:py-32 px-4 sm:px-6 relative border-t border-white/5" id="features">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-5xl md:text-7xl font-black mb-4 sm:mb-6">BUILT FOR <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">EVERYONE.</span></h2>
