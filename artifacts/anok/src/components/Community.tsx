...
export function Community() {
  return (
    <section
      ...
      className="py-20 sm:py-32 px-4 sm:px-6 border-t border-white/5 relative"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
          ...
          >
            <div className="flex gap-2 sm:gap-4 border-b border-white/5 pb-3 sm:pb-4 mb-3 sm:mb-4">
              ...
              <div className="px-3 sm:px-4 py-1.5 sm:py-2 text-foreground/50 font-bold text-xs sm:text-sm">Clan</div>
              <div className="px-3 sm:px-4 py-1.5 sm:py-2 text-foreground/50 font-bold text-xs sm:text-sm">Squad</div>
            </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 id="community-heading" className="text-3xl sm:text-5xl md:text-7xl font-black mb-4 sm:mb-6">
              FIND YOUR <br /><span className="text-secondary">SQUAD.</span>
            </h2>
            ...
            <ul className="space-y-4 sm:space-y-6 list-none p-0 m-0" role="list">
              <li className="flex gap-3 sm:gap-4 items-center">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-secondary/10 flex items-center justify-center border border-secondary/30 flex-shrink-0" aria-hidden="true">
                  <Users className="w-5 h-5 sm:w-6 sm:h-6 text-secondary" />
                </div>
                <div>
                  <h3 className="font-bold text-base sm:text-lg">Clan System 2.0</h3>
                  <p className="text-xs sm:text-sm text-foreground/60">Level up your clan to unlock custom banners and tournaments.</p>
                </div>
              </li>
              <li className="flex gap-3 sm:gap-4 items-center">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-accent/10 flex items-center justify-center border border-accent/30 flex-shrink-0" aria-hidden="true">
                  <Crosshair className="w-5 h-5 sm:w-6 sm:h-6 text-accent" />
                </div>
                <div>
                  <h3 className="font-bold text-base sm:text-lg">LFG Matchmaking</h3>
